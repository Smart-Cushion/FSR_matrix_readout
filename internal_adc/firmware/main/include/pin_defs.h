...
static constexpr size_t NUM_FSR_DRIVE_ADDR_GPIOS = sizeof(FSR_DRIVE_ADDR_GPIOS) / sizeof(FSR_DRIVE_ADDR_GPIOS[0]);
...
// ESP-IDF builds with GNU C; range initializers let unmapped ADC channels use -1.
